...
class TestDomainIntelligenceAgent:
    ...
    async def test_pydantic_ai_agent_direct(self):
        ...
        try:
            ...
            print("✅ PydanticAI Agent[UniversalDeps, UniversalDomainAnalysis]: Direct test successful")
            ...
            print(f"   Vocabulary Complexity: {result.output.characteristics.vocabulary_complexity_ratio}")
    ...
    async def test_content_analysis(self):
        ...
        try:
            ...
            print(f"   Vocabulary Richness: {result.characteristics.vocabulary_richness:.3f}")
            ...
            if "404" in str(e) or "Resource not found" in str(e):
                pytest.skip("Azure OpenAI model configuration issue - service deployed but model access needs configuration")
            else:
                raise
...
class TestKnowledgeExtractionAgent:
    ...
    async def test_pydantic_ai_agent_direct(self):
        ...
        try:
            ...
            print("✅ PydanticAI Agent[UniversalDeps, ExtractionResult]: Direct test successful")
...
class TestUniversalSearchAgent:
    ...
    async def test_pydantic_ai_agent_direct(self):
        ...
        try:
            ...
            sample_prompt = "Search for: Azure Cosmos DB performance optimization techniques"
            ...
            print("✅ PydanticAI Agent[UniversalDeps, MultiModalSearchResult]: Direct test successful")
...
class TestAgentIntegration:
    ...
    def test_universal_deps_initialization(self):
        ...
        try:
            from agents.core.universal_deps import get_universal_deps_sync, UniversalDeps
