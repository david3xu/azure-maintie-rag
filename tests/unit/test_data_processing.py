...
class TestDataTransformationUtils:
    ...
    def test_text_preprocessing(self):
        ...
        for test_case in test_cases:
            ...
            ), f"Failed {test_case['operation']}: '{text}' != '{test_case['expected']}'"
    ...
    def test_data_structure_validation(self):
        ...
        invalid_structures = [
            ...
            {"data": None, "required_fields": ["query"], "valid": False},
            {
        ...
        def validate_data_structure(
            data: Any, required_fields: List[str], check_empty: bool = False
        ) -> bool:
        ...
        for test in valid_structures:
            result = validate_data_structure(
                test["data"], test["required_fields"], test.get("check_empty", False)
            )
...
class TestDataValidationUtils:
    ...
    def test_input_sanitization(self):
        ...
        for input_val, expected in test_cases:
            try:
                ...
                assert (
                    result == expected
                ), f"Sanitization failed: '{result}' != '{expected}'"
    ...
    def test_range_validation(self):
        ...
        def validate_range(
            value: Any, min_val: float, max_val: float, default: float = None
        ) -> float:
            ...
            try:
                ...
                if min_val <= numeric_value <= max_val:
                    ...
                    raise ValueError(
                        f"Value {numeric_value} outside range [{min_val}, {max_val}]"
                    )
