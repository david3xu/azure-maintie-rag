...
class TestAPIEndpoints:
    ...
    async def test_health_endpoint(self, base_url):
        ...
        pytest.skip("API server not running - start with 'uvicorn api.main:app --reload' to test endpoints")
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                if response.status_code in [200, 422, 500]:
                    ...
                    print("✅ Query Endpoint: Exists (may need Azure service configuration)")
                else:
...
class TestStreamingEndpoints:
    ...
    async def test_streaming_endpoint_exists(self):
        ...
        try:
            ...
            if streaming_routes:
                print(f"✅ Streaming Endpoints: Found {len(streaming_routes)} streaming routes")
            else:
