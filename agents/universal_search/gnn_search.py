...
class GNNSearchEngine:
    ...
    async def execute_search(self, query: str, context: Dict[str, Any]) -> ModalityResult:
        ...
        try:
            ...
            pattern_count = min(len(domain_detection.data.matched_patterns), self.max_predictions)
            ...
            metadata = {
                ...
                "predicted_patterns": domain_detection.data.matched_patterns[:pattern_count],
