...
class WorkflowResults(BaseModel):
    ...
    extraction_config: Optional[Dict[str, Any]] = Field(
        None, description="Generated extraction configuration"
    )
    ...
    # Final output
    synthesized_response: Dict[str, Any] = Field(
...
class WorkflowOrchestrator:
    ...
    def __init__(self):
        ...
        self._workflow_stats = {
            ...
            "stage_performance": {
                stage.value: {"count": 0, "avg_time": 0.0} for stage in WorkflowStage
            },
        }
    ...
    async def execute_workflow(
        ...
        try:
            ...
            domain_analysis = await self._execute_domain_analysis(
                request, azure_services
            )
            ...
            await self.performance_monitor.track_domain_intelligence_performance(
                ...
                hybrid_analysis_used=domain_analysis.get("method")
            ...
            await self.performance_monitor.track_config_extraction_pipeline_performance(
                ...
                pipeline_success=extraction_config is not None
                and extraction_results is not None,
            ...
            (
                ...
                confidence_score,
            ) = await self._execute_result_synthesis(
    ...
    async def _execute_domain_analysis(
        self, request: WorkflowRequest, azure_services: ConsolidatedAzureServices
    ) -> Dict[str, Any]:
    ...
    async def _execute_result_synthesis(
        ...
        try:
            ...
            response = {
                ...
                "search_metadata": {
                    "total_execution_time": search_results.get(
                ...
                "confidence_breakdown": {
                    ...
                    "overall_confidence": (
                        domain_analysis.get("confidence", 0.0) + synthesis_confidence
                    )
                    / 2,
                },
            }
    ...
    def _update_workflow_statistics(
        self, execution_time: float, success: bool, stage_times: Dict[str, float]
    ):
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        return {
            **self._workflow_stats,
            "success_rate": (
                self._workflow_stats["successful_workflows"]
                / self._workflow_stats["total_workflows"]
                if self._workflow_stats["total_workflows"] > 0
                else 0.0
            ),
