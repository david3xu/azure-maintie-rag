...
class SystemBoundaryConstants:
    ...
    MAX_EXECUTION_TIME_LIMIT = MathematicalConstants.BASE_TIMEOUT * BaseScalingFactors.MAX_TIMEOUT_FACTOR  # 600.0
    DEFAULT_MEMORY_LIMIT_MB = 200.0           # Memory constraint per operation
    # Aliases for backward compatibility
    BYTES_TO_GB_DIVISOR = MathematicalConstants.BYTES_PER_GB   # Alias for backward compatibility
    BYTES_TO_MB_DIVISOR = MathematicalConstants.BYTES_PER_MB   # Alias for backward compatibility
    ...
    # Aliases for backward compatibility
    MAX_CONFIDENCE = MathematicalConstants.CONFIDENCE_MAX  # Alias for backward compatibility
    ZERO_FLOAT = MathematicalConstants.CONFIDENCE_MIN      # Alias for backward compatibility
...
class InfrastructureConstants:
    ...
    MAX_SEARCH_RESULTS = int(MathematicalConstants.BASE_RESULT_COUNT * BaseScalingFactors.ENTITY_RESULT_FACTOR)  # 50
...
class DomainAdaptiveConstants:
    ...
    DEFAULT_CHUNK_SIZE = int(MathematicalConstants.BASE_CHUNK_SIZE * BaseScalingFactors.STANDARD_CHUNK_FACTOR)  # 1000
    ...
    DOMAIN_DETECTION_THRESHOLD = MathematicalConstants.BASE_CONFIDENCE + BaseScalingFactors.STATISTICAL_CONFIDENCE_OFFSET  # 0.75
    ...
    TECHNICAL_CONTENT_SIMILARITY_THRESHOLD = 0.8 # LEARNABLE: technical vs general content patterns
...
class ContentAnalysisAdaptiveConstants:
    ...
    OPTIMAL_CHUNK_SIZE_MAX = int(MathematicalConstants.BASE_CHUNK_SIZE * BaseScalingFactors.LARGE_CHUNK_FACTOR)  # 2000
...
class PerformanceAdaptiveConstants:
    ...
    AZURE_SERVICE_TIMEOUT = int(MathematicalConstants.BASE_TIMEOUT * BaseScalingFactors.AZURE_TIMEOUT_FACTOR)  # 60
    ...
    CACHE_VERY_HIGH_PERFORMANCE_THRESHOLD = 0.7 # ADAPTIVE: very high performance threshold
...
class StatisticalConstants:
    ...
    DOMAIN_CLASSIFICATION_THRESHOLD = DomainAdaptiveConstants.DOMAIN_CLASSIFICATION_THRESHOLD  
    TECHNICAL_CONTENT_SIMILARITY_THRESHOLD = DomainAdaptiveConstants.TECHNICAL_CONTENT_SIMILARITY_THRESHOLD
...
class WorkflowCoordinationConstants:
    ...
    EXCELLENT_PERFORMANCE_THRESHOLD = 1.0      # COORDINATED: with good/acceptable thresholds
...
class KnowledgeExtractionConstants:
    ...
    FALLBACK_RELATIONSHIP_CONFIDENCE_THRESHOLD = 0.75  # Reference to DomainAdaptiveConstants
...
class WorkflowConstants:
    ...
    BYTES_TO_MB_DIVISOR = MathematicalConstants.BYTES_PER_MB  # Use consolidated constant
...
class CacheConstants:
    ...
    CACHE_OPTIMIZATION_MAX_SIZE = PerformanceAdaptiveConstants.CACHE_OPTIMIZATION_MAX_SIZE
    ...
    BYTES_TO_GB_DIVISOR = MathematicalConstants.BYTES_PER_GB  # Use consolidated constant
    MEMORY_PRECISION_DECIMAL = 2  # Decimal precision for memory measurements
    PERCENTAGE_MULTIPLIER = MathematicalConstants.PERCENTAGE_MULTIPLIER  # Use consolidated constant
    CACHE_TTL_SECONDS = PerformanceAdaptiveConstants.DEFAULT_CACHE_TTL  # Backward compatibility
...
class ProcessingConstants:
    ...
    MAX_EXECUTION_TIME_SECONDS = SystemBoundaryConstants.MAX_EXECUTION_TIME_LIMIT  # Alias for seconds
    MAX_EXECUTION_TIME_MIN = SystemBoundaryConstants.MAX_EXECUTION_TIME_LIMIT / 60.0  # Convert to minutes
...
class ContentAnalysisConstants:
    ...
    MEDIUM_COMPLEXITY_THRESHOLD = ContentAnalysisAdaptiveConstants.MEDIUM_COMPLEXITY_THRESHOLD
    HIGH_SIMILARITY_THRESHOLD = ContentAnalysisAdaptiveConstants.HIGH_SIMILARITY_THRESHOLD
    TECHNICAL_DENSITY_THRESHOLD = ContentAnalysisAdaptiveConstants.TECHNICAL_DENSITY_THRESHOLD
    SHORT_DOCUMENT_WORD_THRESHOLD = ContentAnalysisAdaptiveConstants.SHORT_DOCUMENT_WORD_THRESHOLD
...
def validate_constants() -> List[str]:
    ...
    total_weight = (SearchPerformanceAdaptiveConstants.MULTI_MODAL_WEIGHT_VECTOR + 
    ...
    synthesis_total = (WorkflowCoordinationConstants.CONFIDENCE_WEIGHT +
    ...
    if DomainAdaptiveConstants.RELATIONSHIP_CONFIDENCE_THRESHOLD > DomainAdaptiveConstants.ENTITY_CONFIDENCE_THRESHOLD:
        errors.append("Relationship confidence threshold should not exceed entity confidence threshold")
    
    # Validate chunk overlap is less than chunk size
    if DomainAdaptiveConstants.DEFAULT_CHUNK_OVERLAP >= DomainAdaptiveConstants.DEFAULT_CHUNK_SIZE:
