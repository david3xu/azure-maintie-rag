...
class KnowledgeExtractionToolset(FunctionToolset):
    ...
    def __init__(self):
        ...
        self.add_function(
            self.extract_knowledge_unified, name="extract_knowledge_unified"
        )
        self.add_function(
            self.extract_entities_multi_strategy, name="extract_entities_multi_strategy"
        )
        self.add_function(
            self.extract_relationships_contextual,
            name="extract_relationships_contextual",
        )
        self.add_function(
            self.validate_extraction_quality, name="validate_extraction_quality"
        )
        self.add_function(
            self.generate_knowledge_graph, name="generate_knowledge_graph"
        )

    async def extract_knowledge_unified(
        self,
        ctx: RunContext[KnowledgeExtractionDeps],
        ...
        try:
            ...
            return {
                ...
                "confidence_score": (
                    ...
                    if entities
                    else CacheConstants.ZERO_FLOAT
                ),
            }
    ...
    async def extract_relationships_contextual(
        ...
        try:
            ...
            # Convert to dict format expected by toolset
            relationship_dicts = [
                self.unified_processor._relationship_to_dict(r) for r in relationships
            ]
    ...
    async def generate_knowledge_graph(
        ...
        try:
            ...
            from .processors.unified_extraction_processor import (
                EntityMatch,
                RelationshipMatch,
            )
    ...
    def _format_relationships_as_edges(
