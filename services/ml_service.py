...
class MLService:
    ...
    async def train_gnn_model(self, training_data_path: str, model_config: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        logger.warning("GNN training pipeline is deprecated. Use agents-based tri-modal search instead.")
    ...
    async def predict(self, model_file: str, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                from infrastructure.azure_ml._deprecated.gnn_processor import GNNProcessor
                gnn_processor = GNNProcessor()
                predictions = await gnn_processor.predict(input_data, model_file)
            except ImportError:
                logger.warning("GNN processor not available - using fallback predictions")
    ...
    async def _create_and_train_gnn(self, training_data: Dict, config: Dict) -> Dict[str, Any]:
        ...
        logger.warning("GNN training pipeline is deprecated. This method now returns deprecation notice.")
