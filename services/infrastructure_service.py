...
class SimpleInfrastructureService:
    ...
    def register_service(
        ...
        try:
            ...
            return {"success": False, "service_name": service_name, "error": str(e)}
    ...
    async def check_all_services_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": str(e), "overall_healthy": False}
    ...
    def get_service_info(self, service_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "last_check": (
                    status.get("last_check").isoformat()
...
def register_infrastructure_service(
    service_name: str, service_instance: Any
) -> Dict[str, Any]:
