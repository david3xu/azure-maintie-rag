...
class ModelFactory:
    ...
    @staticmethod
    def create_success_response(query: str, results: List[Dict[str, Any]], **kwargs) -> QueryResponse:
    ...
    @staticmethod
    def create_entity(entity_id: str, text: str, entity_type: str, **kwargs) -> EntityData:
        """Create entity with defaults"""
        return EntityData(id=entity_id, text=text, entity_type=entity_type, **kwargs)
    
    @staticmethod
    def create_relationship(rel_id: str, source: str, target: str, rel_type: str, **kwargs) -> RelationshipData:
    ...
    @staticmethod
    def create_search_result(result_id: str, title: str, content: str, score: float, **kwargs) -> SearchResult:
        """Create search result with defaults"""
        return SearchResult(id=result_id, title=title, content=content, score=score, **kwargs)
