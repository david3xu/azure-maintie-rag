...
class UniversalTextProcessor:
    ...
    def __init__(self, domain_name: str = "general"):
        ...
        logger.info(f"UniversalTextProcessor initialized for domain: {domain_name}")
...
def create_universal_processor(domain_name: str = "general") -> UniversalTextProcessor:
    """Factory function to create universal text processor"""
    return UniversalTextProcessor(domain_name)
