...
class UniversalQueryAnalyzer:
    ...
    def __init__(self, text_processor: Optional[UniversalTextProcessor] = None, domain: str = "general"):
        ...
        logger.info(f"UniversalQueryAnalyzer initialized for domain: {domain}")
...
def create_universal_analyzer(text_processor: Optional[UniversalTextProcessor] = None,
                            domain: str = "general") -> UniversalQueryAnalyzer:
...
if __name__ == "__main__":
    # Example usage
    analyzer = UniversalQueryAnalyzer(domain="maintenance")
