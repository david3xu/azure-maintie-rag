...
class AzureSearchVectorService:
    ...
    def __init__(self, domain: str = "general", model_name: Optional[str] = None):
        ...
        logger.info(f"AzureSearchVectorService initialized for domain: {self.domain}")
...
def create_universal_vector_search(domain: str = "general") -> AzureSearchVectorService:
    """Factory function to create universal vector search"""
    return AzureSearchVectorService(domain)


if __name__ == "__main__":
    # Example usage
    search = AzureSearchVectorService("maintenance")
