...
class UniversalKnowledgeExtractor:
    ...
    def __init__(self, domain_name: str = "general"):
        ...
        logger.info(f"UniversalKnowledgeExtractor initialized for domain: {domain_name}")
...
async def extract_knowledge_from_text_files(
    ...
    Returns:
        Extraction results
    """
    extractor = UniversalKnowledgeExtractor(domain_name)
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        extractor = UniversalKnowledgeExtractor("maintenance")
