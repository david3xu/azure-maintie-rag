...
Works with UniversalTextProcessor and universal models for any domain
"""
...
from core.models.universal_models import UniversalEntity, UniversalRelation
...
class UniversalGNNDataProcessor:
    ...
    def __init__(self, text_processor: UniversalTextProcessor, domain: str = "general"):
        ...
        logger.info(f"UniversalGNNDataProcessor initialized for domain: {domain}")
...
MaintIEGNNDataProcessor = UniversalGNNDataProcessor


def create_universal_gnn_processor(text_processor: UniversalTextProcessor,
                                 domain: str = "general") -> UniversalGNNDataProcessor:
    """Factory function to create universal GNN data processor"""
    return UniversalGNNDataProcessor(text_processor, domain)
...
if __name__ == "__main__":
    ...
    processor = UniversalTextProcessor("maintenance")
    gnn_processor = UniversalGNNDataProcessor(processor, "maintenance")
