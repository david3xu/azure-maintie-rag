...
def validate_data_consistency():
    ...
    print(f"   ✅ Relationships preserved: {len(relationships)} → {graph_data.edge_index.size(1)//2} edges")
    print(f"   ✅ Graph structure: {graph_data.validate()} (PyTorch Geometric validation)")
...
def main():
    ...
    try:
        ...
        print("print(f'Graph: {graph_data.x.size(0)} nodes, {graph_data.edge_index.size(1)} edges')")
