...
def store_knowledge_to_cosmos(extraction_file: str, domain: str = "maintenance"):
    ...
    for relationship in relationships:
        ...
        if source_id and target_id and source_id != target_id:
            ...
            result = cosmos_client.add_edge(source_id, target_id, relation_type, properties)
    ...
    print(f"   Vertices: {final_stats['vertices']} (added {final_stats['vertices'] - initial_stats['vertices']})")
    print(f"   Edges: {final_stats['edges']} (added {final_stats['edges'] - initial_stats['edges']})")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--extraction-file', required=True, help='Knowledge extraction JSON file')
