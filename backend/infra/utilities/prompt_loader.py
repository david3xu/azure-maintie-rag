...
class PromptTemplateLoader:
    ...
    def __init__(self):
        ...
        self.knowledge_extraction_dir = self.prompt_flows_dir / "universal_knowledge_extraction"
    ...
    def load_template(self, template_name: str) -> Optional[Template]:
        ...
        try:
            ...
            logger.error(f"Template not found: {template_name} in {self.knowledge_extraction_dir}")
            return None
    ...
    def render_knowledge_extraction_prompt(
        ...
        try:
            ...
            if not extraction_focus:
                ...
                extraction_focus = DomainPatternManager.get_extraction_focus(domain_name)
            ...
            if not template:
                ...
                return self._fallback_hardcoded_prompt(text_content, domain_name, extraction_focus)
    ...
    def _fallback_hardcoded_prompt(self, text_content: str, domain_name: str, extraction_focus: str) -> str:
...
def load_knowledge_extraction_prompt(text_content: str, domain: str = "maintenance") -> str:
...
if __name__ == "__main__":
    ...
    test_prompt = loader.render_knowledge_extraction_prompt(
        text_content="air conditioner thermostat not working",
