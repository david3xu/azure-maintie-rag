...
class AzureDataWorkflowEvidenceCollector:
    ...
    async def record_azure_service_evidence(
        ...
        logger.debug(f"Recorded evidence for {azure_service} operation: {operation_type}")
        return evidence
    ...
    async def generate_workflow_evidence_report(self) -> Dict[str, Any]:
        ...
        try:
            ...
            total_processing_time = sum(e.processing_time_ms for e in self.evidence_chain)
            ...
            for evidence in self.evidence_chain:
                ...
                service_breakdown[service]["total_cost"] += evidence.cost_estimate_usd or 0.0
                service_breakdown[service]["total_time_ms"] += evidence.processing_time_ms
