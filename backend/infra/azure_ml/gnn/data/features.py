...
- Azure-only deployment - requires OpenAI connection
...
from infra.models.gnn_data_models import (
    StandardizedEntity,
    StandardizedRelation, 
    StandardizedGraphData
)
from infra.azure_openai.openai_client import UnifiedAzureOpenAIClient as AzureOpenAIService
...
class SemanticFeatureEngine:
    ...
    - Azure-only deployment - no offline scenarios supported
    """
