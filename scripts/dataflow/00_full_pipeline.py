...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Azure Universal RAG - Complete Pipeline")
    parser.add_argument("--data-dir", default="/workspace/azure-maintie-rag/data/raw", help="Data directory")
    parser.add_argument("--skip-prerequisites", action="store_true", help="Skip Azure services state check")
    parser.add_argument("--verbose", action="store_true", help="Verbose output with detailed progress")
    ...
    # Run the pipeline
    result = asyncio.run(run_universal_full_pipeline(
