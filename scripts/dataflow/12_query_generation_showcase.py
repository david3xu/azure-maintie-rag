...
async def query_generation_showcase(
    ...
    try:
        ...
        sample_relationships = [
            {"subject": "Azure RAG System", "predicate": "USES", "object": "Knowledge Graph", "confidence": 0.89},
            {"subject": "Azure RAG System", "predicate": "POWERED_BY", "object": "PydanticAI", "confidence": 0.92}
        ]
        ...
        graph_traversal_query = await generate_gremlin_query(
            ...
            entities=[],
            relationships=[],
            graph_context={"start_entity": "Azure RAG System", "traversal_type": "outbound"},
            max_results=20,
            traversal_depth=3
        )
        ...
        gremlin_showcase = {
            ...
            "queries_generated": {
                "entity_insertion": {
                    "query": entity_insertion_query.query[:100] + "..." if len(entity_insertion_query.query) > 100 else entity_insertion_query.query,
                ...
                "relationship_insertion": {
                    "query": relationship_insertion_query.query[:100] + "..." if len(relationship_insertion_query.query) > 100 else relationship_insertion_query.query,
                    "complexity": relationship_insertion_query.estimated_complexity,
                    "explanation": relationship_insertion_query.explanation
                },
                "graph_traversal": {
                    "query": graph_traversal_query.query[:100] + "..." if len(graph_traversal_query.query) > 100 else graph_traversal_query.query,
        ...
        print(f"   ✅ Entity insertion query: {entity_insertion_query.estimated_complexity} complexity")
        print(f"   ✅ Relationship insertion query: {relationship_insertion_query.estimated_complexity} complexity")  
        print(f"   ✅ Graph traversal query: {graph_traversal_query.estimated_complexity} complexity")
        ...
        print(f"   ✅ Vector search query: {vector_search_query.estimated_performance} performance")
        print(f"   ✅ Hybrid search query: {hybrid_search_query.estimated_performance} performance")
        ...
        domain_analysis_query = await generate_analysis_query(
            ...
            domain_context={"analysis_focus": "technical_density", "target_domain": "AI/ML"},
            analysis_depth="deep",
            target_metrics=["vocabulary_complexity", "technical_density", "concept_coverage"]
        )
        ...
        performance_optimization_query = await generate_analysis_query(
            ...
            content_samples=sample_content,
            domain_context={"system_type": "RAG", "target_metrics": ["speed", "accuracy"]},
            target_metrics=["processing_speed", "extraction_accuracy", "search_relevance"],
            optimization_goals=["reduce_latency", "improve_precision", "enhance_recall"]
        )
        ...
        print(f"   ✅ Domain characterization: {domain_analysis_query.complexity_level} complexity")
        print(f"   ✅ Performance optimization: {performance_optimization_query.complexity_level} complexity")
        ...
        batch_requests = [
            ...
            QueryRequest(
                ...
                context={"search_text": "neural network architecture", "domain_context": {"research_indicators": 0.8}},
        ...
        batch_responses = await query_orchestrator.generate_multi_query_batch(batch_requests)
        ...
        orchestration_showcase = {
            ...
            "batch_processing": {
                ...
                "success_rate": successful_queries / len(batch_requests) if batch_requests else 0,
        ...
        print(f"   ✅ Batch processing completed: {successful_queries}/{len(batch_requests)} successful")
        print(f"   📊 Success rate: {(successful_queries/len(batch_requests)*100):.1f}%")
        print(f"   🏎️  Cache size: {orchestration_showcase['cache_stats']['cache_size']} entries")
        print(f"   ⏱️  Orchestration: {orchestration_duration:.2f}s\n")
        
        # Final Summary
        total_time = time.time() - start_time
        total_queries_generated = sum(
            len(showcase.get("queries_generated", {})) for showcase in results["showcases"]
        ...
        results.update({
            ...
            "summary": {
                ...
                "query_types_demonstrated": ["gremlin", "search", "analysis", "batch_orchestration"],
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Query Generation Showcase - PydanticAI SQL Pattern")
    ...
    result = asyncio.run(query_generation_showcase(
    ...
    if result["overall_status"] == "completed":
        ...
        print(f"   🤖 Queries generated: {result['summary']['total_queries_generated']}")
